...
var gen_data = {
    ...
    "Lost Dungeon": ["Black", "Dark", "Dread", "Forsaken", "Lost", "Secret"],
    ...
    "Dungeon Horror": ["Ages", "Annihilation", "Chaos", "Death", "Devastation", "Doom", "Evil", "Horror", "Madness", "Malice", "Necromancy", "Nightmares",
        "Ruin", "Secrets", "Sorrows", "Souls", "Terror", "Woe", "Worms"
    ],
    "The Darklord": ["${ Named Darklord }", "${ Darklord Name }", "${ Darklord Name } the ${ Darklord Epithet }", "The ${ Monster Epithet } ${ Noble Title }"],
    ...
    "Monster Epithet": ["Demon", "Gargoyle", "Lich", "Shadow", "Vampire", "Wraith", "Wyrm"],
